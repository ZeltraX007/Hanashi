...
export default function About() {
  ...
  <div className="frst">
   ...
   <div className="content"><p className="nam">Priyanka Sarkar</p><p className="q"><br/></p></div>
   {/* <div></div> */}
   </div>
   ...
   <div className="row row2">
    ...
    <div className="content"><p className="nam">Aritra Sarkar</p><p className="q"></p></div>
   ...
   <div className="row row3">
    ...
    <div className="content"><p className="nam">Sanchari Chakraborty</p><p className="q"></p></div>
   ...
   <div className="row row4">
    ...
    <div className="content"><p className="nam">Sreejita Rakshit</p><p className="q"></p></div>
