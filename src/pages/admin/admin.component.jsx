...
export default function About() {
  ...
  <div className="frst">
   ...
   <div className="content"><p className="name">Priyanka Sarkar</p><p className="q">"I need a dog"<br/></p></div>
   {/* <div></div> */}
   </div>
   ...
   <div className="row row2">
    ...
    <div className="content"><p className="name">Aritra Sarkar</p><p className="q">"Just put this &gt;&gt;&gt; <br /> <strong>"I am done"</strong> "<br/></p></div>
   ...
   <div className="row row3">
    ...
    <div className="content"><p className="name">Sanchari Chakraborty</p><p className="q">"What I wish is that I could tell myself<br /> that painting and photography <br />remain a small part in my life"</p></div>
   ...
   <div className="row row4">
    ...
    <div className="content"><p className="name">Sreejita Rakshit</p><p className="q">"I do my work at the same time <br />each day - the last minute."<br /></p></div>
